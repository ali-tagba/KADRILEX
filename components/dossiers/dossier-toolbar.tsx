...
import { countActiveDossierFilters, type DossierFiltersState, type ViewMode } from "./filters-state"
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-lg flex items-center gap-2 p-density-tight">
            ...
            <div className="relative flex-1 min-w-0">
                ...
                <input
                    ...
                    placeholder="Rechercher (N° dossier, client, partie adverse, juridiction…)"
