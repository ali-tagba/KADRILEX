...
import { countActiveFilters, type TachesFiltersState, type ViewMode } from "./filters-state"
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-lg flex items-center gap-2 p-density-tight">
            ...
            <div className="relative flex-1 min-w-0">
                ...
                <input
                    ...
                    placeholder="Rechercher une tâche (titre, description, avocat…)"
            ...
            <div className="flex bg-surface-container-low rounded overflow-hidden border border-outline-variant">
                ...
                >
                    <span className="material-symbols-outlined text-[18px] block">view_kanban</span>
                </button>
            </div>
        </div>
    )
